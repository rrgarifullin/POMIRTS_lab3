...
{REDUND_CONTEXT} {REDUND_UNREPLICABLE}  FUNCTION_BLOCK INAcreate		(*creates a dynamic data FIFO*)
	VAR_INPUT
...
{REDUND_CONTEXT} {REDUND_UNREPLICABLE}  FUNCTION_BLOCK INAdelete		(*deletes a data object specified by ident*)
	VAR_INPUT
		enable	:BOOL;			(*enables execution*)
...
{REDUND_CONTEXT} {REDUND_UNREPLICABLE}  FUNCTION_BLOCK INADevOpen		(*opens an INA device*)
	VAR_INPUT
		enable	:BOOL;			(*enables execution*)
...
{REDUND_CONTEXT} {REDUND_UNREPLICABLE}  FUNCTION_BLOCK INADevOpenEx		(*expands open for an INA device*)
	VAR_INPUT
		enable	:BOOL;			(*enables execution*)
		pDevice	:UDINT;			(*pointer to a device string*)
...
{REDUND_CONTEXT} {REDUND_UNREPLICABLE}  FUNCTION_BLOCK INADevClose		(*closes an INA device*)
	VAR_INPUT
		enable	:BOOL;			(*enables execution*)
		pDevice	:UDINT;			(*pointer to a device string*)
	END_VAR
