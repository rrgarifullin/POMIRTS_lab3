...
{REDUND_CONTEXT} FUNCTION_BLOCK MTMpcMimoEnhanced (*Model based predictive controller including control-/model-performance inidices*)
	VAR_INPUT
	...
	END_VAR
	VAR
		BasicAdjustment : {REDUND_UNREPLICABLE} MTMpcMimoParameterType; (*Internal controller settings*)
		Internal : MTMpcMimoEnhancedInternalType; (*Data for internal use*)
	END_VAR
END_FUNCTION_BLOCK

{REDUND_OK} FUNCTION_BLOCK MTMpcMimoLite (*Model based predictive controller*)
	VAR_INPUT
		Enable : BOOL; (*Enable function block*)
		Parameter : MTMpcMimoParameterType; (*Access to controller settings (target settings)*)
...
{REDUND_OK} FUNCTION_BLOCK MTMpcMimoOilFractionator (*Linear time invariant multiple-variable oil-fractionator model*) (*$GROUP=User*)
	VAR_INPUT
		Enable : BOOL; (*Enable function block*)
