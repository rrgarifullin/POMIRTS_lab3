...
{REDUND_CONTEXT} {REDUND_UNREPLICABLE} FUNCTION_BLOCK PROFIBUSCommand 				(*sends PROFIBUS commands*)
	VAR_INPUT
...
{REDUND_CONTEXT} {REDUND_UNREPLICABLE} FUNCTION_BLOCK PROFIBUSStart 				(*starts cyclic I/O-data exchange*)
	VAR_INPUT
		enable: 					BOOL; 	(*enables execution*)
		pDevice: 					UDINT; 	(*device name given as a pointer*)
...
{REDUND_CONTEXT} {REDUND_UNREPLICABLE} FUNCTION_BLOCK PROFIBUSStop 				(*stops cyclic I/O-data exchange*)
	VAR_INPUT
		enable: 					BOOL; 	(*enables execution*)
...
{REDUND_CONTEXT} {REDUND_UNREPLICABLE} FUNCTION_BLOCK PROFIBUSSlaveStat 			(*reads diagnostic information for defined PROFIBUS device*)
	VAR_INPUT
		enable: 					BOOL; 	(*enables execution*)
		pDevice: 					UDINT; 	(*device name given as a pointer*)
...
{REDUND_CONTEXT} {REDUND_UNREPLICABLE} FUNCTION_BLOCK PROFIBUSControl 				(*passes information from internal interface to fieldbus device driver and DMP mailbox structures*)
	VAR_INPUT
		enable: 					BOOL; 	(*enables execution*)
		pDevice: 					UDINT; 	(*device name given as a pointer*)
		InRx: 						USINT;  (*receiver*)
...
{REDUND_CONTEXT} {REDUND_UNREPLICABLE} FUNCTION_BLOCK PROFIBUSControlExt 			(*passes information from internal interface to fieldbus device driver and DMP mailbox structures*)
	VAR_INPUT
		enable: 					BOOL; 	(*enables execution*)
		pDevice: 					UDINT; 	(*device name given as a pointer*)
		InRx: 						USINT;  (*receiver*)
...
{REDUND_CONTEXT} {REDUND_UNREPLICABLE} FUNCTION_BLOCK PROFIBUSDPV1AlarmReceive 	(*returns alarm information for a certain slave*)
	VAR_INPUT
		enable: 					BOOL; 	(*enables execution*)
		pDevice: 					UDINT; 	(*device name given as a pointer*)
		RemoteAddress: 				USINT; 	(*station address of the requested slave 0-126*)
...
{REDUND_CONTEXT} {REDUND_UNREPLICABLE} FUNCTION_BLOCK PROFIBUSDPV1AlarmReset 		(*acknowledges a received DPV1 alarm*)
	VAR_INPUT
		enable: 					BOOL; 	(*enables execution*)
		pDevice: 					UDINT; 	(*device name given as a pointer*)
		RemoteAddress: 				USINT; 	(*station address of the requested slave 0-126*)
...
{REDUND_CONTEXT} {REDUND_UNREPLICABLE} FUNCTION_BLOCK PROFIBUSDPV1Read 			(*reads request for a datablock is transferred to a DPV1-slave*)
	VAR_INPUT
		enable: 					BOOL; 	(*enables execution*)
		pDevice: 					UDINT; 	(*device name given as a pointer*)
		RemoteAddress: 				USINT; 	(*station address of the requested slave 0-126*)
...
{REDUND_CONTEXT} {REDUND_UNREPLICABLE} FUNCTION_BLOCK PROFIBUSDPV1Write 			(*writes request for a datablock is transferred to a DPV1-slave*)
	VAR_INPUT
		enable: 					BOOL; 	(*enables execution*)
		pDevice: 					UDINT; 	(*device name given as a pointer*)
		RemoteAddress: 				USINT; 	(*station address of the requested slave 0-126*)
