...
{REDUND_OK} FUNCTION_BLOCK MTHydValvePositionController (*Hydraulic position controller.*) (*$GROUP=AdvControl,$CAT=Hydraulics,$GROUPICON=iconGroupX.png,$CATICON=iconCategoryX.png*)
	VAR_INPUT
...
{REDUND_OK} FUNCTION_BLOCK MTHydValveForceController (*Hydraulic position controller.*) (*$GROUP=AdvControl,$CAT=Hydraulics,$GROUPICON=iconGroupX.png,$CATICON=iconCategoryX.png*)
	VAR_INPUT
		Enable : BOOL; (*Enables/Disables the function block.*) (* *) (*#PAR#*)
...
{REDUND_OK} FUNCTION_BLOCK MTHydValvePressureObserver (*Chamber pressure observer.*) (*$GROUP=AdvControl,$CAT=Hydraulics,$GROUPICON=iconGroupX.png,$CATICON=iconCategoryX.png*)
	VAR_INPUT
		Enable : BOOL; (*Enables/Disables the function block.*) (* *) (*#PAR#*)
...
{REDUND_OK} FUNCTION_BLOCK MTHydValveSimulationModel (*Valve simulation model.*) (*$GROUP=AdvControl,$CAT=Hydraulics,$GROUPICON=iconGroupX.png,$CATICON=iconCategoryX.png*)
	VAR_INPUT
		Enable : BOOL; (*Enables/Disables the function block.*) (* *) (*#PAR#*)
		...
		ActPumpPressure : REAL; (*Actual pump pressure. Units: [bar].*) (* *) (*#CYC#OPT#*)
		ProcessForce : {REDUND_UNREPLICABLE} REAL; (*Actual cylinder pressure in chamber 1. Units: [bar].*) (* *) (*#CYC#OPT#*)
	END_VAR
	VAR_OUTPUT
		Active : BOOL; (*Function block is active. *) (* *) (*#PAR#*)
		Error : BOOL; (*Indicates an error.*) (* *) (*#PAR#*)
...
{REDUND_OK} FUNCTION_BLOCK MTHydValveLinearization (*Valve linearization. *) (*$GROUP=AdvControl,$CAT=Hydraulics,$GROUPICON=iconGroupX.png,$CATICON=iconCategoryX.png*)
	VAR_INPUT
		Enable : BOOL; (*Enables/Disables the function block.*) (* *) (*#PAR#*)
...
{REDUND_OK} FUNCTION_BLOCK MTHydValveIdentification (*Valve characteristics identification.*) (*$GROUP=AdvControl,$CAT=Hydraulics,$GROUPICON=iconGroupX.png,$CATICON=iconCategoryX.png*)
	VAR_INPUT
		Enable : BOOL; (*Enables/Disables the function block.*) (* *) (*#PAR#*)
