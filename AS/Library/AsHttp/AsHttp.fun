 ...
 * Author: B+R
 ********************************************************************
 * Functions and function blocks of library AsHttp
 ********************************************************************)

FUNCTION_BLOCK httpService (*offers a webservice ; asynchronous execution*)
	VAR_INPUT
...
FUNCTION_BLOCK httpClient (*sends and recieves HTTP messages (web requests); asynchronous execution*)
	VAR_INPUT
...
FUNCTION_BLOCK httpUtf8ToString (*converts a UTF8 string in string with respect to given code page mapping*)
	VAR_INPUT
...
FUNCTION_BLOCK httpStringToUtf8 (*converts a string in UTF8 string with respect to given code page mapping*)
	VAR_INPUT
		enable : BOOL; (*enables execution*)
...
FUNCTION_BLOCK httpUtf8ToWString (*converts a UTF8 encoded string in wide character string*)
	VAR_INPUT
		enable : BOOL; (*enables execution*)
		pSrc : UDINT; (*input string, given as a pointer*)
		pDest : UDINT; (*destination buffer*)
...
FUNCTION_BLOCK httpWStringToUtf8 (*converts a wide character string in UTF8 string*)
	VAR_INPUT
		enable : BOOL; (*enables execution*)
		pSrc : UDINT; (*input string, given as a pointer*)
		pDest : UDINT; (*destination buffer*)
...
FUNCTION_BLOCK httpDecodeBase64 (*decodes base64 encoded string in binary data or string*)
	VAR_INPUT
		enable : BOOL; (*enables execution*)
...
FUNCTION_BLOCK httpEncodeBase64 (*encodes binary data or a string in a base64 encoded string*)
	VAR_INPUT
		enable : BOOL; (*enables execution*)
...
FUNCTION_BLOCK httpEncodeUrl (*encodes special chars in the given string according the URL encoding*)
	VAR_INPUT
		enable : BOOL; (*enables execution*)
		pSrc : UDINT; (*input string, given as a pointer*)
		pDest : UDINT; (*destination buffer, given as a pointer*)
...
FUNCTION_BLOCK httpDecodeUrl (*decodes an URL encoded string*)
	VAR_INPUT
		enable : BOOL; (*enables execution*)
		pSrc : UDINT; (*input string, given as a pointer*)
		pDest : UDINT; (*destination buffer, given as a pointer*)
...
FUNCTION_BLOCK httpGetParamUrl (*retrieves the string value of the given parameter.*)
	VAR_INPUT
		enable : BOOL; (*enables execution*)
		pSrc : UDINT; (*input string, given as a pointer*)
...
FUNCTION_BLOCK httpSetParamUrl (*adds a parameter and its value with respect to URL encoding*)
	VAR_INPUT
		enable : BOOL; (*enables execution*)
...
FUNCTION_BLOCK httpSetBoundary (*adds the boundary information to the HTTP message header*)
	VAR_INPUT
		enable : BOOL; (*enables execution*)
...
FUNCTION_BLOCK httpGetBoundary (*retrieves the boundary value of the given header structure*)
	VAR_INPUT
		enable : BOOL; (*enables execution*)
		pStruct : UDINT; (*pointer to the header structure (httpRequestHeader_t or httpResponseHeader_t)*)
...
FUNCTION_BLOCK httpSetMultipartMessage (*sets respectivly appends a multipart message*)
	VAR_INPUT
		enable : BOOL; (*enables execution*)
...
FUNCTION_BLOCK httpGetMultipartMessage (*gets next multipart message information on each call*)
	VAR_INPUT
		enable : BOOL; (*enables execution*)
