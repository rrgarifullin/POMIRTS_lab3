 ...
 * Author: B+R
 ********************************************************************
 * Functions and function blocks of library AsNxDpS
 ********************************************************************)

FUNCTION_BLOCK nxdpsSubscribe			(*subscribe slave*)
	VAR_INPUT
...
FUNCTION_BLOCK nxdpsUnsubscribe			(*unsubscribe slave*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
	END_VAR
...
FUNCTION_BLOCK nxdpsAlarmNotification	(*alarm notification*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
...
FUNCTION_BLOCK nxdpsAlarmAckReceive		(*receive alarm acknowledgement*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
	END_VAR
...
FUNCTION_BLOCK nxdpsV1C1WriteInd		(*V1 class 1 write indication*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
...
FUNCTION_BLOCK nxdpsV1C1WriteAck		(*V1 class 1 write acknowledgement*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
...
FUNCTION_BLOCK nxdpsV1C1ReadInd			(*V1 class 1 read indication*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
	END_VAR
...
FUNCTION_BLOCK nxdpsV1C1ReadAck			(*V1 class 1 read acknowledgement*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
		ackType			: BOOL;			(*type of acknowledgement*)
...
FUNCTION_BLOCK nxdpsSetDiag				(*set diagnostic*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
...
FUNCTION_BLOCK nxdpsSetIm0				(*change I&M0 parameter settings*)
	VAR_INPUT
		enable				: BOOL;			(*enables execution*)
		pDevice				: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
...
FUNCTION_BLOCK nxdpsSetAdr				(*set address*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
...
FUNCTION_BLOCK nxdpsStartBusComm		(*start bus communication*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
	END_VAR
...
FUNCTION_BLOCK nxdpsV1C2InitiateInd		(*V1 class2 initiate connection indication*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
...
FUNCTION_BLOCK nxdpsV1C2InitiateRes		(*V1 class 2 initiate connection response*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
		ackType			: BOOL;			(*type of acknowledgement*)
...
FUNCTION_BLOCK nxdpsV1C2ReadInd			(*V1 class 2 read indication*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
	END_VAR
...
FUNCTION_BLOCK nxdpsV1C2ReadRes			(*V1 class 2 read response*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
		ackType			: BOOL;			(*type of acknowledgement*)
...
FUNCTION_BLOCK nxdpsV1C2WriteInd		(*V1 class 2 write indication*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
		maxDataLen		: UDINT;		(*max data length*)
...
FUNCTION_BLOCK nxdpsV1C2WriteRes		(*V1 class 2 write response*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
		ackType			: BOOL;			(*type of acknowledgement*)
...
FUNCTION_BLOCK nxdpsV1C2DataInd			(*V1 class 2 data transport indication*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
		maxDataLen		: UDINT;		(*max data length*)
...
FUNCTION_BLOCK nxdpsV1C2DataRes			(*V1 class 2 data transport response*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
		ackType			: BOOL;			(*type of acknowledgement*)
...
FUNCTION_BLOCK nxdpsV1C2AbortInd		(*V1 class 2 abort indication*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
	END_VAR
...
FUNCTION_BLOCK nxdpsV1C2AbortRes		(*V1 class 2 abort response*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
		connectionRef	: UDINT;		(*connection reference*)
