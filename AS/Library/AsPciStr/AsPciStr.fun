...
FUNCTION pciMemSet : UDINT		(*fills the memory area with specific values*)
	VAR_INPUT
	...
	END_VAR
END_FUNCTION
FUNCTION pciMemCpy : UDINT		(*copies the memory area*)
	VAR_INPUT
		pDest	:UDINT;		(*pointer to the destination memory*)
	...
	END_VAR
END_FUNCTION
FUNCTION pciMemMove : UDINT	(*copies the memory area (even if the memory areas overlap)*)
	VAR_INPUT
		pDest	:UDINT;		(*pointer to the destination memory*)
		pSrc	:UDINT;		(*pointer to the data to be copied*)
		length	:UDINT;		(*size of bytes to be copied*)
	END_VAR
END_FUNCTION
FUNCTION pciMemCmp : DINT		(*compares memory areas*)
	VAR_INPUT
	...
	END_VAR
END_FUNCTION
FUNCTION pciStrCat : UDINT		(*attaches character strings to one another*)
	VAR_INPUT
		pDest	:UDINT;		(*pointer to the destination character string*)
		pSrc	:UDINT;		(*pointer to the source character string*)
	END_VAR
END_FUNCTION
FUNCTION pciStrCpy : UDINT		(*copies one character string into another*)
	VAR_INPUT
		pDest	:UDINT;		(*pointer to the destination character string*)
		pSrc	:UDINT;		(*pointer to the source character string*)
	END_VAR
END_FUNCTION
FUNCTION pciStrCmp : DINT		(*compares two character strings*)
	VAR_INPUT
