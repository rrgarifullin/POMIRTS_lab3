 ...
 FUNCTION_BLOCK MTHydPumpSimulationModel (*Simulation model of a hydraulic servo pump system with sero pump, switching valve and hydraulic cylinder.*) (*$GROUP=AdvControl,$CAT=Hydraulics,$GROUPICON=iconGroupX.png,$CATICON=iconCategoryX.png*)
	VAR_INPUT
...
END_FUNCTION_BLOCK
 ...
 FUNCTION_BLOCK MTHydPumpController (*Pressure and speed controller function block for controlling a hydraulic servo pump system.*) (*$GROUP=AdvControl,$CAT=Hydraulics,$GROUPICON=iconGroupX.png,$CATICON=iconCategoryX.png*)
	VAR_INPUT
...
END_FUNCTION_BLOCK
 ...
 FUNCTION_BLOCK MTHydPumpDriveProtection (*Pump and drive protection function block.*) (*$GROUP=AdvControl,$CAT=Hydraulics,$GROUPICON=iconGroupX.png,$CATICON=iconCategoryX.png*)
	VAR_INPUT
		Axis : UDINT; (*Axis reference.*) (* *) (*#PAR#*)
		Enable : BOOL; (*Enables/Disables the function block.*) (* *) (*#PAR#*)
