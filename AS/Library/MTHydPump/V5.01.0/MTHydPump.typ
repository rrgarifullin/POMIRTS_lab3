...
Permitted range of values: DurationTime = 0.*)
	...
	MTHydPumpTuningInternalType : 	STRUCT  (*Data for internal use.*)
		...
		TaskIdentCtrlCalc :  UDINT;
		TaskIdentBode :  UDINT;
		TaskIdent :  UDINT;
		asyncBode :  asyncBodeType;
		SystemIdentStep :  MTHydPumpTuningSystemIdentEnum;
		asyncCtrlCalc :  asyncCtrlCalcType;
		asyncLSQ :  asyncLSQType;
	...
	asyncCtrlCalcType : 	STRUCT  (*Data for internal use.*)
		Status :  UDINT;
		Done :  BOOL;
		Step :  MTHydPumpTuningAsyncEnum;
		Active :  BOOL;
		LS_FB :  MTAdvancedLoopShaping;
	END_STRUCT;
