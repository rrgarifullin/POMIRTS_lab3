 ...
 * Author: B+R
 ********************************************************************
 * Functions and function blocks of library AsEth
 ********************************************************************)
                                                                      
FUNCTION_BLOCK EthStat					(*retrieves an interface's statistics; asynchronous execution*)
	VAR_INPUT
...
FUNCTION ethInetAton : UINT				(*converts an IP address from internet-format to binary value*)
	VAR_INPUT
...
FUNCTION ethInetNtoa : UINT				(*converts an IP address from binary value to internet-format*)
	VAR_INPUT
