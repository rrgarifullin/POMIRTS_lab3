...
FUNCTION_BLOCK LCRPID (* PID controller. *)
	VAR_INPUT
		enable : BOOL;
		ident : UDINT;
		W : REAL;
...
FUNCTION_BLOCK LCRScal (* Scaling of REAL signals. *)
	VAR_INPUT
		x : REAL;
		x1 : REAL;
		y1 : REAL;
...
FUNCTION_BLOCK LCRPIDpara (* Manual configuration of the PID controller. *)
	VAR_INPUT
		enable : BOOL;
		enter : BOOL;
		WX_max : REAL;
...
FUNCTION_BLOCK LCRRamp (* Ramp generator. *)
	VAR_INPUT
		enable : BOOL;
		x : REAL;
		dy_up : REAL;
...
FUNCTION_BLOCK LCRIntegrate (* Integrator with limits and set value. *)
	VAR_INPUT
		enable : BOOL;
		x : REAL;
		tn : REAL;
...
FUNCTION_BLOCK LCRLimit (* Limiter with overrun indicators. *)
	VAR_INPUT
		in : REAL;
		max_value : DINT;
		min_value : DINT;
...
FUNCTION_BLOCK LCRLimScal (* Scaling and limiting of REAL signals. *)
	VAR_INPUT
		x : REAL;
		x1 : REAL;
		y1 : REAL;
...
FUNCTION_BLOCK LCRMovAvgFlt (* Floating average value filter. *)
	VAR_INPUT
		enable : BOOL;
		x : REAL;
		base : UINT;
...
FUNCTION_BLOCK LCRDifferentiate (* Differentiator with filter. *)
	VAR_INPUT
		enable : BOOL;
		x : REAL;
		tv : REAL;
...
FUNCTION_BLOCK LCRTt (* Delay time. *)
	VAR_INPUT
		enable : BOOL;
		Tt : DINT;
		x : REAL;
...
FUNCTION_BLOCK LCRPT2 (* Second-order delay element. *)
	VAR_INPUT
		enable : BOOL;
		V : REAL;
		T1 : REAL;
...
FUNCTION_BLOCK LCRPT1e (* First-order delay element. *)
	VAR_INPUT
		enable : BOOL;
		V : REAL;
		T1 : REAL;
...
FUNCTION_BLOCK LCRMinMax (* Smallest and largest peak value. *)
	VAR_INPUT
		reset : BOOL;
		in : REAL;
	END_VAR
...
FUNCTION_BLOCK LCRPT2o (* Oscillating 2nd order delay element. *)
	VAR_INPUT
		enable : BOOL;
		V : REAL;
		D : REAL;
