...
_WEAK const unsigned char LCRPID_MODE_OFF = 0;
...
_WEAK const unsigned short LCR_ERR_LCRPIDTune_MAXMIN = 31564;
...
_WEAK const unsigned short LCR_WARN_LCRPIDTune_OSC_HYST = 12020;
