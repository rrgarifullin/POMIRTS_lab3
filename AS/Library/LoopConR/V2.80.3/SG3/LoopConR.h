...
/* Constants */
 ...
 _IEC_CONST unsigned short LCRTEMP_STEP_ERROR = 65535U;
 _IEC_CONST unsigned short LCR_ERR_DISABLED = 65534U;
 _IEC_CONST unsigned short LCR_ERR_PT2O_TF_NEG_ZERO = 33154U;
 _IEC_CONST unsigned short LCR_ERR_PT2O_D_NEG = 33153U;
 _IEC_CONST unsigned short LCR_ERR_LCRTEMPTune_DT_IGNORED = 33152U;
 ...
 _IEC_CONST unsigned short LCR_WARN_PT2O_TF_TS = 33102U;
 _IEC_CONST unsigned short LCR_WARN_LCRTEMPTune_ASYNC = 33101U;
 _IEC_CONST unsigned short LCR_WARN_LCRTEMPTune_DT_HIGH = 33100U;
 _IEC_CONST unsigned short LCR_ERR_SCHEDULE_N = 31574U;
 _IEC_CONST unsigned short LCR_ERR_SCHEDULE_P = 31573U;
 _IEC_CONST unsigned short LCR_ERR_LCRTEMPPID_NO_TALT = 31572U;
 _IEC_CONST unsigned short LCR_ERR_LCRTEMPPID_TKNICK = 31571U;
 ...
 _IEC_CONST unsigned short LCR_ERR_LCRPID_PAR_DEADBAND_MODE = 12042U;
 ...
 _IEC_CONST unsigned short LCRTEMP_STEP_DONE = 130U;
 _IEC_CONST unsigned short LCRTEMP_STEP_PID_DONE = 125U;
 _IEC_CONST unsigned short LCRTEMP_STEP_PID_DONE_COOLONLY = 122U;
 _IEC_CONST unsigned short LCRTEMP_STEP_COOL = 120U;
 _IEC_CONST unsigned short LCRPID_TUNE_ADDINFO_OSC_PERIOD = 111U;
 _IEC_CONST unsigned short LCRTEMP_STEP_START_COOL = 110U;
 _IEC_CONST unsigned short LCRTEMP_STEP_WAIT_COOLONLY = 105U;
 ...
 _IEC_CONST unsigned short LCRTEMP_STEP_WAIT_COOL = 100U;
 _IEC_CONST unsigned long LCRPID_TUNE_REQU_PID = 100U;
 _IEC_CONST unsigned long LCRSLIMPID_REQU_PID = 100U;
 _IEC_CONST unsigned short LCRTEMP_STEP_PID_COOL = 90U;
 _IEC_CONST unsigned short LCRTEMP_STEP_PID = 80U;
 _IEC_CONST unsigned short LCRTEMP_STEP_FREE = 70U;
 _IEC_CONST unsigned short LCRTEMP_STEP_START_FREE = 60U;
 _IEC_CONST unsigned short LCRTEMP_STEP_WAIT_FREE = 50U;
 ...
 _IEC_CONST unsigned short LCRTEMP_STEP_PID_FREE = 40U;
 _IEC_CONST unsigned short LCRTEMP_STEP_HEAT = 30U;
 ...
 _IEC_CONST unsigned short LCRTEMP_STEP_START_HEAT = 20U;
 ...
 _IEC_CONST unsigned short LCRTEMP_STEP_WAIT_HEAT = 10U;
 ...
 _IEC_CONST unsigned char LCRPID_FBK_MODE_SET_YI = 5U;
 _IEC_CONST unsigned char LCRPID_MODE_FREEZE = 5U;
 _IEC_CONST unsigned short LCRTEMP_STEP_WAIT = 5U;
 _IEC_CONST unsigned long LCRSLIMPID_REQU_WRITE_PARAS = 4U;
 _IEC_CONST unsigned char LCRPID_MODE_CLOSE = 4U;
 _IEC_CONST unsigned char LCRPID_FBK_MODE_LIMIT_YI = 4U;
 ...
 _IEC_CONST unsigned char LCRPID_DEADBAND_MODE_STANDARD_I = 2U;
 ...
 _IEC_CONST unsigned char LCRTEMP_HYST_MODE_JOLTFREE = 1U;
 ...
 _IEC_CONST unsigned char LCRPID_DEADBAND_MODE_STANDARD = 1U;
 ...
 _IEC_CONST unsigned char LCRPID_DEADBAND_MODE_ZERO = 0U;
#endif
...
void LCRPT2o(struct LCRPT2o* inst);
void LCRSchedulePWM(struct LCRSchedulePWM* inst);
