 ...
 * Author: B+R
 ********************************************************************
 * Functions and function blocks of library AsUPS
 ********************************************************************)
                                                                      
FUNCTION_BLOCK ups_comm					(*transfers additional parameters and commands to the UPS*)
	VAR_INPUT
...
FUNCTION_BLOCK ups_init					(*initializes the connection and transfer of UPS parameters*)
	VAR_INPUT
		enable	:BOOL;					(*enables execution*)
...
FUNCTION_BLOCK ups_getcomstate			(*monitors handshake transmissions and shutdowns for automation runtime*)
	VAR_INPUT
		enable	:BOOL;					(*enables execution*)
	END_VAR
	VAR_OUTPUT
...
FUNCTION ups_ar_shutdown : UINT			(*restarts or shuts down automation runtime*)
	VAR_INPUT	
		enable	:BOOL;					(*enables execution*)
...
FUNCTION ups_deinit : UINT				(*closes all internal connections and releases the interface*)
	VAR_INPUT
		enable	:BOOL;					(*enables execution*)
	END_VAR
END_FUNCTION
