...
typedef struct HCRF_Cont_Internal_typ
{
	float Qnom_pos;
	float Qnom_neg;
	unsigned long _0006_A_Cyl_pos_dbl_1;
	unsigned long _0006_A_Cyl_pos_dbl_2;
	unsigned long _0006_A_Cyl_neg_dbl_1;
	unsigned long _0006_A_Cyl_neg_dbl_2;
	plcbit enable_old;
	unsigned long Bootkey;
...
typedef struct HCRSPF_Internal_typ
{
	...
	unsigned long AccVec_dbl[24];
	unsigned long ConstVec_dbl[24];
	unsigned long DecVec_dbl[24];
...
typedef struct HRCLinSpline_Internal_typ
{
...
typedef struct HRCNode_Internal_typ
{
	float X;
	float Y;
	float X1;
...
} HRCNode_Internal_typ;

typedef struct HCRNode_typ
{
	float X;
	float Y;
	HRCNode_Internal_typ Internal;
} HCRNode_typ;
...
typedef struct HCRLinSpline
{
	...
	unsigned short status;
	/* VAR (analogous) */
	struct HRCLinSpline_Internal_typ Internal;
	/* VAR_INPUT (digital) */
	plcbit enable;
	plcbit Invert;
	plcbit Update;
