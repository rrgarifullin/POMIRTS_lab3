...
/* Constants */
 ...
 #define HCR_ERR_SPF_PER_S_HOME 32311U
 #define HCR_ERR_SPF_T_JOLT_NEG 32294U
 #define HCR_ERR_SPF_VC_NEG_NEG 32295U
 #define HCR_ERR_SPF_VC_POS_NEG 32296U
 ...
 #define HCR_WARN_SPF_PER_S_END 32415U
 ...
 #define HCR_ERR_SPF_PER_S_PERIOD_NEG 32312U
...
#else
 _IEC_CONST unsigned short HCR_ERR_DISABLED = 65534U;
 _IEC_CONST unsigned short HCR_ERR_FIFO_MEM = 32256U;
 _IEC_CONST unsigned short HCR_WARN_SPF_MEM = 32412U;
 _IEC_CONST unsigned short HCR_ERR_VALVE_Y_0 = 32285U;
 _IEC_CONST unsigned short HCR_ERR_IT1_T1_NEG = 32313U;
 _IEC_CONST unsigned short HCR_ERR_PID_KW_0_1 = 32264U;
 _IEC_CONST unsigned short HCR_ERR_PID_TF_NEG = 32266U;
 _IEC_CONST unsigned short HCR_ERR_PID_TV_NEG = 32270U;
 _IEC_CONST unsigned short HCR_ERR_PT2S_D_NEG = 32276U;
 _IEC_CONST unsigned short HCR_ERR_SFG_T_DIFF = 32316U;
 _IEC_CONST unsigned short HCR_WARN_IT1_T1_TS = 32416U;
 _IEC_CONST unsigned short HCR_WARN_IT1_TN_TS = 32418U;
 _IEC_CONST unsigned short HCR_WARN_PID_TF_TS = 32386U;
 _IEC_CONST unsigned short HCR_WARN_PID_TV_TS = 32389U;
 _IEC_CONST unsigned short HCR_ERR_DT12S_D_NEG = 32250U;
 _IEC_CONST unsigned short HCR_ERR_PID_NIL_PTR = 32305U;
 _IEC_CONST unsigned short HCR_ERR_PID_TF_ZERO = 32267U;
 _IEC_CONST unsigned short HCR_ERR_PT12_T1_NEG = 32273U;
 _IEC_CONST unsigned short HCR_ERR_PT12_T2_NEG = 32274U;
 _IEC_CONST unsigned short HCR_ERR_SERVO_Y_MIN = 32278U;
 _IEC_CONST unsigned short HCR_ERR_SPF_NIL_PTR = 32293U;
 _IEC_CONST unsigned short HCR_ERR_VALVE_Q_NOM = 32284U;
 _IEC_CONST unsigned short HCR_WARN_PID_YI_MAX = 32391U;
 _IEC_CONST unsigned short HCR_WARN_PID_YI_MIN = 32392U;
 _IEC_CONST unsigned short HCR_WARN_PT12_T1_TS = 32395U;
 _IEC_CONST unsigned short HCR_WARN_PT12_T2_TS = 32397U;
 _IEC_CONST unsigned short HCR_WARN_PT2S_TF_TS = 32401U;
 _IEC_CONST unsigned short HCR_WARN_SFG_FP_END = 32419U;
 _IEC_CONST unsigned short HCR_ERR_DT12S_T1_NEG = 32251U;
 _IEC_CONST unsigned short HCR_ERR_DT12S_T2_NEG = 32253U;
 _IEC_CONST unsigned short HCR_ERR_DT12S_TF_NEG = 32318U;
 _IEC_CONST unsigned short HCR_ERR_DT12S_TV_NEG = 32255U;
 _IEC_CONST unsigned short HCR_ERR_PT1CP_T1_NEG = 32275U;
 _IEC_CONST unsigned short HCR_ERR_SYSTEM_A_CYL = 32279U;
 _IEC_CONST unsigned short HCR_ERR_SYSTEM_H_CYL = 32297U;
 _IEC_CONST unsigned short HCR_ERR_SYSTEM_M_CYL = 32298U;
 _IEC_CONST unsigned short HCR_WARN_DT12S_T1_TS = 32370U;
 _IEC_CONST unsigned short HCR_WARN_DT12S_T2_TS = 32372U;
 _IEC_CONST unsigned short HCR_WARN_DT12S_TF_TS = 32374U;
 _IEC_CONST unsigned short HCR_WARN_DT12S_TV_TS = 32375U;
 _IEC_CONST unsigned short HCR_WARN_IT1_T1_ZERO = 32417U;
 _IEC_CONST unsigned short HCR_WARN_LIN_NB_NODE = 32382U;
 _IEC_CONST unsigned short HCR_WARN_NOTCH_F0_FS = 32414U;
 _IEC_CONST unsigned short HCR_WARN_PT1CP_T1_TS = 32399U;
 _IEC_CONST unsigned short HCR_WARN_SERVO_Y_MAX = 32411U;
 _IEC_CONST unsigned short HCR_ERR_OMEGA0_X0_CYL = 32309U;
 _IEC_CONST unsigned short HCR_ERR_PID_K_FBK_NEG = 32265U;
 _IEC_CONST unsigned short HCR_ERR_PID_Y_MAX_MIN = 32272U;
 _IEC_CONST unsigned short HCR_ERR_SERVO_MODE_FY = 32303U;
 _IEC_CONST unsigned short HCR_ERR_SERVO_MODE_VY = 32304U;
 _IEC_CONST unsigned short HCR_ERR_SYSTEM_P_DIFF = 32280U;
 _IEC_CONST unsigned short HCR_ERR_SYSTEM_P_TANK = 32282U;
 _IEC_CONST unsigned short HCR_ERR_SYSTEM_V0_NEG = 32301U;
 _IEC_CONST unsigned short HCR_ERR_SYSTEM_V0_POS = 32302U;
 _IEC_CONST unsigned short HCR_ERR_VALVE_NIL_PTR = 32306U;
 _IEC_CONST unsigned short HCR_WARN_PID_YADD_100 = 32390U;
 _IEC_CONST unsigned short HCR_WARN_PID_YMAN_MAX = 32393U;
 _IEC_CONST unsigned short HCR_WARN_PID_YMAN_MIN = 32394U;
 _IEC_CONST unsigned short HCR_WARN_PT12_T1_ZERO = 32396U;
 _IEC_CONST unsigned short HCR_WARN_PT12_T2_ZERO = 32398U;
 _IEC_CONST unsigned short HCR_ERR_PID_DY_MAX_NEG = 32262U;
 _IEC_CONST unsigned short HCR_ERR_PID_TN_NEG_NEG = 32268U;
 _IEC_CONST unsigned short HCR_ERR_PID_TN_POS_NEG = 32269U;
 _IEC_CONST unsigned short HCR_ERR_PID_WX_MAX_MIN = 32271U;
 _IEC_CONST unsigned short HCR_ERR_SFG_T_JOLT_NEG = 32317U;
 _IEC_CONST unsigned short HCR_ERR_SPF_PER_S_HOME = 32311U;
 _IEC_CONST unsigned short HCR_ERR_SPF_T_JOLT_NEG = 32294U;
 _IEC_CONST unsigned short HCR_ERR_SPF_VC_NEG_NEG = 32295U;
 _IEC_CONST unsigned short HCR_ERR_SPF_VC_POS_NEG = 32296U;
 _IEC_CONST unsigned short HCR_ERR_SYSTEM_NIL_PTR = 32299U;
 _IEC_CONST unsigned short HCR_WARN_DT12S_T1_ZERO = 32371U;
 _IEC_CONST unsigned short HCR_WARN_DT12S_T2_ZERO = 32373U;
 _IEC_CONST unsigned short HCR_WARN_DT12S_TV_ZERO = 32376U;
 _IEC_CONST unsigned short HCR_WARN_PID_TN_NEG_TS = 32387U;
 _IEC_CONST unsigned short HCR_WARN_PID_TN_POS_TS = 32388U;
 _IEC_CONST unsigned short HCR_WARN_PT1CP_T1_ZERO = 32400U;
 _IEC_CONST unsigned short HCR_WARN_SPF_PER_S_END = 32415U;
 _IEC_CONST unsigned short HCR_ERR_FIFO_T_FIFO_NEG = 32257U;
 _IEC_CONST unsigned short HCR_ERR_IT1_TN_NEG_ZERO = 32314U;
 _IEC_CONST unsigned short HCR_ERR_RAMP_T_FALL_NEG = 32286U;
 _IEC_CONST unsigned short HCR_ERR_RAMP_T_HOLD_NEG = 32287U;
 _IEC_CONST unsigned short HCR_ERR_RAMP_T_RISE_NEG = 32288U;
 _IEC_CONST unsigned short HCR_ERR_SYSTEM_P_SUPPLY = 32281U;
 _IEC_CONST unsigned short HCR_WARN_FIFO_T_FIFO_TS = 32378U;
 _IEC_CONST unsigned short HCR_WARN_LIN_CRIT_RNESS = 32381U;
 _IEC_CONST unsigned short HCR_ERR_DT12S_T1_T2_ZERO = 32252U;
 _IEC_CONST unsigned short HCR_ERR_NOTCH_B_NEG_ZERO = 32307U;
 _IEC_CONST unsigned short HCR_ERR_PT2S_TF_NEG_ZERO = 32277U;
 _IEC_CONST unsigned short HCR_WARN_FIFO_T_FIFO_INT = 32377U;
 _IEC_CONST unsigned short HCR_WARN_SERVO_V_CYL_MAX = 32410U;
 _IEC_CONST unsigned short HCR_WARN_SFG_T_DELTA_ACT = 32420U;
 _IEC_CONST unsigned short HCR_ERR_DT12S_TF_NEG_ZERO = 32254U;
 _IEC_CONST unsigned short HCR_ERR_JFREE_TSWITCH_NEG = 32258U;
 _IEC_CONST unsigned short HCR_ERR_LIN_NODEVEC_EMPTY = 32259U;
 _IEC_CONST unsigned short HCR_ERR_NOTCH_F0_NEG_ZERO = 32308U;
 _IEC_CONST unsigned short HCR_ERR_VALVE_P_DELTA_NOM = 32283U;
 _IEC_CONST unsigned short HCR_WARN_SERVO_FF_CYL_NEG = 32402U;
 _IEC_CONST unsigned short HCR_WARN_SERVO_FF_CYL_POS = 32403U;
 _IEC_CONST unsigned short HCR_ERR_LIN_X_NOT_ASC_DESC = 32260U;
 _IEC_CONST unsigned short HCR_ERR_LIN_Y_NOT_ASC_DESC = 32261U;
 _IEC_CONST unsigned short HCR_ERR_PID_D_MODE_INVALID = 32263U;
 _IEC_CONST unsigned short HCR_WARN_JFREE_TSWITCH_5TS = 32379U;
 _IEC_CONST unsigned short HCR_ERR_SPF_VC_NEG_NEG_ZERO = 32295U;
 _IEC_CONST unsigned short HCR_ERR_SPF_VC_POS_NEG_ZERO = 32296U;
 _IEC_CONST unsigned short HCR_ERR_SYSTEM_P_SUPPLY_MAX = 32300U;
 _IEC_CONST unsigned short HCR_WARN_JFREE_TSWITCH_ZERO = 32380U;
 _IEC_CONST unsigned short HCR_WARN_LIN_Y_NOT_ASC_DESC = 32384U;
 _IEC_CONST unsigned short HCR_ERR_OMEGA0_X_CYL_MIN_MAX = 32310U;
 _IEC_CONST unsigned short HCR_ERR_SFG_T_DELTA_NEG_ZERO = 32315U;
 _IEC_CONST unsigned short HCR_ERR_SPF_PER_S_PERIOD_NEG = 32312U;
 _IEC_CONST unsigned short HCR_WARN_AUTOTUNE_KP_INVALID = 32413U;
 _IEC_CONST unsigned short HCR_WARN_SERVO_P_CYL_NEG_LOW = 32405U;
 _IEC_CONST unsigned short HCR_WARN_SERVO_P_CYL_NEG_NEG = 32406U;
 _IEC_CONST unsigned short HCR_WARN_SERVO_P_CYL_POS_LOW = 32408U;
 _IEC_CONST unsigned short HCR_WARN_SERVO_P_CYL_POS_NEG = 32409U;
 _IEC_CONST unsigned short HCR_WARN_LIN_X_NOT_ASC_DESC_S = 32383U;
 _IEC_CONST unsigned short HCR_WARN_LIN_Y_NOT_ASC_DESC_S = 32385U;
 _IEC_CONST unsigned short HCR_WARN_SERVO_P_CYL_NEG_HIGH = 32404U;
 _IEC_CONST unsigned short HCR_WARN_SERVO_P_CYL_POS_HIGH = 32407U;
 _IEC_CONST unsigned short HCR_ERR_SPF_A_ACC_NEG_NEG_ZERO = 32289U;
 _IEC_CONST unsigned short HCR_ERR_SPF_A_ACC_POS_NEG_ZERO = 32290U;
 _IEC_CONST unsigned short HCR_ERR_SPF_A_DEC_NEG_NEG_ZERO = 32291U;
 _IEC_CONST unsigned short HCR_ERR_SPF_A_DEC_POS_NEG_ZERO = 32292U;
#endif
...
typedef struct HCRSPF_Internal_typ
{
	...
	plcbit aDec_intrude;
	float s_period;
	unsigned long s_period_Sum_dbl_1;
	unsigned long s_period_Sum_dbl_2;
	signed long Nb_period;
	float t_Jolt_max;
	float t_Jolt_limit;
	float t_Jolt;
	...
	unsigned long Bootkey;
	float s_period_ext;
	signed short PeriodicMode_ext;
	signed char NewPeriod_ext_out;
} HCRSPF_Internal_typ;
...
void HCRsF_Cont_p(struct HCRsF_Cont_p* inst);
void HCRNotch(struct HCRNotch* inst);
void HCRs_Cont_p(struct HCRs_Cont_p* inst);
void HCRAutoTune(struct HCRAutoTune* inst);
void HCRRampGen(struct HCRRampGen* inst);
void HCRPT1(struct HCRPT1* inst);
void HCRDT1(struct HCRDT1* inst);
void HCRLinSpline(struct HCRLinSpline* inst);
void HCRsF_Cont(struct HCRsF_Cont* inst);
void HCRvyServo_Fp(struct HCRvyServo_Fp* inst);
void HCRvyServo(struct HCRvyServo* inst);
void HCRPID(struct HCRPID* inst);
void HCRIT1(struct HCRIT1* inst);
void HCROmega0(struct HCROmega0* inst);
void HCRP2P_Cont(struct HCRP2P_Cont* inst);
void HCRF_Cont_p(struct HCRF_Cont_p* inst);
void HCRPT2(struct HCRPT2* inst);
void HCRPT2s(struct HCRPT2s* inst);
void HCRDT2s(struct HCRDT2s* inst);
void HCRPT1cP(struct HCRPT1cP* inst);
void HCRJoltFree(struct HCRJoltFree* inst);
void HCRLinValve(struct HCRLinValve* inst);
void HCRF_Cont(struct HCRF_Cont* inst);
void HCRs_Cont(struct HCRs_Cont* inst);
void HCRSPF(struct HCRSPF* inst);
void HCRFyServo_Fp(struct HCRFyServo_Fp* inst);
void HCRFIFO(struct HCRFIFO* inst);
void HCRDT2(struct HCRDT2* inst);
void HCRSFG(struct HCRSFG* inst);
void HCRFyServo(struct HCRFyServo* inst);
