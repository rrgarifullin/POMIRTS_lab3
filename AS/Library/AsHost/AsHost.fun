 ...
 * Author: B+R
 ********************************************************************
 * Functions and function blocks of library AsHost
 ********************************************************************)
                                                                      
FUNCTION_BLOCK HostByName					(*returns the accompanying IP address for the specified host name*)
	VAR_INPUT
...
FUNCTION_BLOCK HostByAddress				(*returns the accompanying host name for the specified IP address*)
	VAR_INPUT
		enable       : BOOL; 				(*enables execution*)
