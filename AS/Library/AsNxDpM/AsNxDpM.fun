 ...
 * Author: B+R
 ********************************************************************
 * Functions and function blocks of library AsNxDpM
 ********************************************************************)
                                                                     
FUNCTION_BLOCK nxdpmCommand				(*send command*)
	VAR_INPUT
...
FUNCTION_BLOCK nxdpmSetMode				(*set mode*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
...
FUNCTION_BLOCK nxdpmActivate			(*activate/deactivate slave*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
		remoteAdr		: UDINT;		(*remote address*)
...
FUNCTION_BLOCK nxdpmGetDiag				(*get diagnostic*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
		remoteAdr		: UDINT;		(*remote address*)
...
FUNCTION_BLOCK nxdpmLifeList			(*life list*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
...
FUNCTION_BLOCK nxdpmV1C1Read			(*DPV1 class 1 read request*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
		remoteAdr		: UDINT;		(*remote address*)
...
FUNCTION_BLOCK nxdpmV1C1Write			(*DPV1 class 1 write request*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
		remoteAdr		: UDINT;		(*remote address*)
...
FUNCTION_BLOCK nxdpmSubscribe			(*subscribe master*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
	END_VAR
...
FUNCTION_BLOCK nxdpmUnsubscribe			(*unsubscribe master*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
	END_VAR
...
FUNCTION_BLOCK nxdpmAlarmReceive		(*receive alarm*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
		remoteAdr		: UDINT;		(*remote address*)
...
FUNCTION_BLOCK nxdpmAlarmReset			(*reset alarm*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
		remoteAdr		: UDINT;		(*remote address*)
...
FUNCTION_BLOCK nxdpmV1C2Initiate		(*DPV1 class 2 initiate connection*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
		remoteAdr		: UDINT;		(*remote address*)
...
FUNCTION_BLOCK nxdpmV1C2Read			(*DPV1 class 2 read request*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
		connectionRef	: UDINT;		(*connection reference*)
...
FUNCTION_BLOCK nxdpmV1C2Write			(*DPV1 class 2 write request*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
		connectionRef	: UDINT;		(*connection reference*)
...
FUNCTION_BLOCK nxdpmV1C2Data			(*combined DPV1 class 2 read and write request*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
		connectionRef	: UDINT;		(*connection reference*)
...
FUNCTION_BLOCK nxdpmV1C2Abort			(*V1 class 2 request abort of connection*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
		connectionRef	: UDINT;		(*connection reference*)
