 ...
 * Author: B+R
 ********************************************************************
 * Functions and function blocks of library AsNxPnS
 ********************************************************************)

FUNCTION_BLOCK nxpnsProcessAlarm		(*process alarm*)
	VAR_INPUT
...
FUNCTION_BLOCK nxpnsDiagnosisAlarm		(*diagnosis alarm*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
		deviceHandle	: UDINT;		(*profinet slave handle*)
...
FUNCTION_BLOCK nxpnsPlugModule			(*plug module*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
		deviceHandle	: UDINT;		(*profinet slave handle*)
...
FUNCTION_BLOCK nxpnsPullModule			(*pull module*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
		deviceHandle	: UDINT;		(*profinet slave handle*)
...
FUNCTION_BLOCK nxpnsGetHandle			(*get slave handle*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
	END_VAR
...
FUNCTION_BLOCK nxpnsAddChannelDiag		(*add channel diagnosis*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
		api				: UDINT;		(*api*)
...
FUNCTION_BLOCK nxpnsAddExtChannelDiag	(*add channel diagnosis*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
		api				: UDINT;		(*api*)
...
FUNCTION_BLOCK nxpnsAddGenChannelDiag	(*add channel diagnosis*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
		api				: UDINT;		(*api*)
...
FUNCTION_BLOCK nxpnsRemChannelDiag		(*remove channel diagnosis*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
		diagHandle		: UDINT;		(*diagnosis handle*)
...
FUNCTION_BLOCK nxpnsSetName				(*set station name*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
...
FUNCTION_BLOCK nxpnsStartBusComm		(*start bus communication*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
	END_VAR
