...
FUNCTION_BLOCK mbReadCoils							(*mfc Read Coils; asynchronous execution*)
	VAR_INPUT
...
FUNCTION_BLOCK mbReadDiscreteInputs					(*mfc Read Discrete Inputs; asynchronous execution*)
	VAR_INPUT
		enable			: BOOL;						(*enables execution*)
		pStation		: UDINT;					(*pointer to the station path e.g."IF2.ST1"*)
		startAddress	: UINT;						(*starting address*)
...
FUNCTION_BLOCK mbReadHoldingRegisters		(*mfc Read Holding Registers; asynchronous execution*)
	VAR_INPUT
		enable			: BOOL;				(*enables execution*)
		pStation		: UDINT;			(*pointer to the station path e.g. "IF2.ST1"*)
		startAddress	: UINT;				(*starting address*)
...
FUNCTION_BLOCK mbReadInputRegisters			(*mfc Read Input Register; asynchronous execution*)
	VAR_INPUT
		enable			: BOOL;				(*enables execution*)
		pStation		: UDINT;			(*pointer to the station path e.g."IF2.ST1"*)
		startAddress	: UINT;				(*starting address*)
...
FUNCTION_BLOCK mbWriteSingleCoil			(*mfc Write Single Coil; asynchronous execution*)
	VAR_INPUT
		enable			: BOOL;				(*enables execution*)
		pStation		: UDINT;			(*pointer to the station path e.g."IF2.ST1"*)
		startAddress	: UINT;				(*starting address*)
...
FUNCTION_BLOCK mbWriteSingleRegister		(*mfc Write Single Register; asynchronous execution*)
	VAR_INPUT
		enable			: BOOL;				(*enables execution*)
		pStation		: UDINT;			(*pointer to the station path e.g."IF2.ST1"*)
		startAddress	: UINT;				(*starting address*)
...
FUNCTION_BLOCK mbWriteMultipleCoils					(*mfc Write Multiple Coils; asynchronous execution*)
	VAR_INPUT
		enable			: BOOL;						(*enables execution*)
		pStation		: UDINT;					(*pointer to the station path e.g."IF2.ST1"*)
		startAddress	: UINT;						(*starting address*)
...
FUNCTION_BLOCK mbWriteMultipleRegisters		(*mfc Write Multiple Registers; asynchronous execution*)
	VAR_INPUT
		enable			: BOOL;				(*enables execution*)
		pStation		: UDINT;			(*pointer to the station path e.g."IF2.ST1"*)
		startAddress	: UINT;				(*starting address*)
...
FUNCTION_BLOCK mbReadWriteMultipleRegisters	(*mfc Read Write Multiple Registers; asynchronous execution*)
	VAR_INPUT
		enable				: BOOL;			(*enables execution*)
		pStation			: UDINT;		(*pointer to the station path e.g."IF2.ST1"*)
...
FUNCTION_BLOCK mbGetLastException			(*get last modbus exception; asynchronous execution*)
	VAR_INPUT
		enable				: BOOL;			(*enables execution*)
		pStation			: UDINT;		(*pointer to the station path e.g."IF2.ST1"*)
	END_VAR
