 ...
 * Author: B+R
 ********************************************************************
 * Functions and function blocks of library AsIOVib
 ********************************************************************)

FUNCTION_BLOCK vbioCM4810 (*This function block can be used to access the data of X20CM4810 modules.*)
	VAR_INPUT
...
FUNCTION_BLOCK vbioCtrlCM4810 (*This function block can be used to access the data of X20CM4810 modules.*)
	VAR_INPUT
		enable : BOOL; (*Enable function block.*)
		paramMain : vbioParamMain_t; (*Main parameter structure.*)
		paramBufferUpload : vbioParamBufferUpload_t; (*Parameter structure for the module buffer upload.*)
