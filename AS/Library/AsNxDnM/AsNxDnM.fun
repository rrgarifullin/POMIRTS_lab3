 ...
 * Author: B+R
 ********************************************************************
 * Functions and function blocks of library AsNxDnM
 ********************************************************************)

FUNCTION_BLOCK nxdnmSetOperationMode	(*set operation mode*)
	VAR_INPUT
...
FUNCTION_BLOCK nxdnmGetAttribute		(*get attribute*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
...
FUNCTION_BLOCK nxdnmSetAttribute		(*set attribute*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
		macId			: USINT;		(*device mac id*)
...
FUNCTION_BLOCK nxdnmAcyclicBitStrobing	(*acyclic bit strobing*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
...
FUNCTION_BLOCK nxdnmLifeList			(*life list*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
		timeout			: UDINT;		(*timeout*)
...
FUNCTION_BLOCK nxdnmDiagnostics			(*diagnostics*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pDevice			: UDINT;		(*interface name given as a pointer, e.g., "SL<x>.SS<y>.IF<z>"*)
		macId			: USINT;		(*device mac id*)
