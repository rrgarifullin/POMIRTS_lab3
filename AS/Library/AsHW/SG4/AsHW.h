...
void HwGetBatteryInfo(struct HwGetBatteryInfo* inst);
...
void HwSetUserLED(struct HwSetUserLED* inst);
unsigned short HwSetBeep(unsigned long frequency, unsigned long beepTime);
