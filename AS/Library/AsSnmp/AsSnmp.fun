 ...
 * Author: B+R
 ********************************************************************
 * Functions and function blocks of library AsSnmp
 ********************************************************************)
                                                                      
FUNCTION_BLOCK snmpV1Get				(*requests one or more parameters of a network participant; asynchronous execution*)
	VAR_INPUT
...
FUNCTION_BLOCK snmpV1Set				(*sets one or more parameters of a network participant; asynchronous execution*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pHost			: UDINT;		(*pointer to IP address or host name of a network participant*)
		pCommunity		: UDINT;		(*pointer to the community name for authentication*)
...
FUNCTION_BLOCK snmpV1SendTrap			(*sends a snmp trap; asynchronous execution*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		pHost			: UDINT;		(*pointer to IP address or host name of a network participant*)
		pCommunity		: UDINT;		(*pointer to the community name for authentication*)
