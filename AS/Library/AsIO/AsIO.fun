 ...
 * Author: B+R
 ********************************************************************
 * Functions and function blocks of library AsIO
 ********************************************************************)
                                                                      
FUNCTION_BLOCK AsIODPStatus				(*determines the state and current value of an I/O data point; asynchronous execution*)
	VAR_INPUT
...
FUNCTION_BLOCK AsIOSetForceValue		(*sets the value of an I/O data point's "force" status; asynchronous execution*)
	VAR_INPUT
		enable       : BOOL; 			(*enables execution*)
		pDatapoint   : UDINT; 			(*I/O data point name given as a pointer*)
...
FUNCTION_BLOCK AsIOEnableForcing		(*enables the "force" status of an I/O data point; asynchronous execution*)
	VAR_INPUT	
		enable       : BOOL; 			(*enables execution*)
		pDatapoint   : UDINT; 			(*I/O data point name given as a pointer*)
	END_VAR
...
FUNCTION_BLOCK AsIODisableForcing		(*disables the "force" status of an I/O data point; asynchronous execution*)
	VAR_INPUT
		enable       : BOOL; 			(*enables execution*)
		pDatapoint   : UDINT; 			(*I/O data point name given as a pointer*)
	END_VAR
...
FUNCTION_BLOCK AsIOGlobalDisableForcing	(*disables the "force" status of all I/O data points; asynchronous execution*)
	VAR_INPUT
		enable           : BOOL; 		(*enables execution*)
	END_VAR
...
FUNCTION_BLOCK AsIOListDP				(*determines the existing I/O data points; asynchronous execution*)
	VAR_INPUT
		enable       : BOOL; 			(*enables execution*)
...
FUNCTION_BLOCK AsIOPVInfo				(*collects data about PV's that are linked with a data point; asynchronous execution*)
   VAR_INPUT
       enable     : BOOL;				(*enables execution*)
       pDatapoint : UDINT;				(*I/O data point name given as a pointer*)
